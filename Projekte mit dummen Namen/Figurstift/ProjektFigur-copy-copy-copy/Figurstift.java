...
public class Figurstift extends Buntstift
{
    ...
    //Pi berechnen durch die Leibnitz Reihe
    public void lebnitzreihe()
    {
        double pi=1;
        double vorzeichen = -1.0;
        for( int i=3 ; i<2000000000 ; i=i+2) // in 2er Schritten
        {
            pi = pi+ vorzeichen*1.0/(double)i;
            vorzeichen = vorzeichen*(-1.0);
        }
        pi=4.0*pi;
        this.schreibeText("Pi ist ca. " +pi);
    }
}
